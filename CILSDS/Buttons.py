...
class ButtonSW(Button):
  ...
  def DrawContent(self):
    ...
    gc.StrokeLines([(40 - 6, 20), (40 - 6, 11), (40 - 28, 29), (40 - 6, 49),
                    (40 - 6, 40)])
...
class ButtonArrowRight(Button):
  ...
  def DrawContent(self):
    margin = 1
    self.gc.StrokeLines([(margin, margin), (self.w - margin, self.h / 2),
                         (margin, self.h - margin), (margin, margin)])
...
class ButtonArrowLeft(Button):
  ...
  def DrawContent(self):
    margin = 1
    self.gc.StrokeLines([(margin, self.h / 2), (self.w - margin, margin),
...
class ButtonArrowDown(Button):
  ...
  def DrawContent(self):
    margin = 1
    self.gc.StrokeLines([(margin, margin), (self.w / 2, self.h - margin),
                         (self.w - margin, margin), (margin, margin)])
...
class ButtonArrowUp(Button):
  ...
  def DrawContent(self):
    margin = 1
    self.gc.StrokeLines([(self.w / 2, margin), (margin, self.h - margin),
                         (self.w - margin, self.h - margin),
                         (self.w / 2, margin)])
...
class ButtonNumSpin(Button):
  ...
  def DrawContent(self):
    ...
    gc.DrawLines([(w2 - 8, y + te[1] + 5), (w2, self.h),
                  (w2 + 8, y + te[1] + 5)])
